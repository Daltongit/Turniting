document.addEventListener('DOMContentLoaded', () => {
    ...
    // Simulador Chat Slide 6 (Función global para el HTML)
    ...
    // ==========================================
    // 2. LÓGICA DEL TEST INTERACTIVO Y SUS PANTALLAS
    // ==========================================

    // Funciones Globales para abrir y cerrar el test desde el HTML
    ...
    ]; // Añade las otras 40 aquí dentro del corchete
    ...
    function startGame() {
        ...
        window.mostrarPantallaJuego('game-screen'); loadQuestion();
    }
    ...
    document.getElementById('btn-new-lobby').addEventListener('click', () => { resetLobby(); window.mostrarPantallaJuego('test-lobby-screen'); });
